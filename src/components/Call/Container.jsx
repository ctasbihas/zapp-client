...
function Container({ data }) {
	...
	return (
		<div className="border-conversation-border border-l w-full bg-conversation-panel-background flex flex-col items-center justify-center h-screen overflow-hidden text-white">
